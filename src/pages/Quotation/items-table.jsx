...
const ItemsTable = ({
  ...
  onClick={() => setHiddenColumns(prev => ({ ...prev, hideDescription: !prev.hideDescription }))}
>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                {!hideDescription && <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Description</th>}
